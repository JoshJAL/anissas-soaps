  ...
  return (
    <div className='flex flex-col gap-10'>
      ...
      <div className='w-full flex flex-col items-center justify-center gap-12'>
        <div className='bg-mint md:rounded-tl-[150px] md:rounded-br-[150px] rounded-tl-[75px] rounded-br-[75px] w-screen py-10 px-5'>
          <div className='w-full flex md:flex-row flex-col  justify-around md:gap-32 gap-10 max-w-7xl mx-auto'>
            ...
            <section className='text-center md:w-1/2 flex gap-5 flex-col'>
              ...
              <p className='text-2xl'>
                Please reach out to Anissa below to start the process of designing, picking the right scent, and
